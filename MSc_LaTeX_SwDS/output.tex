...
add all three & 11.78 & 11.81 & 11.76 & 11.70 & 11.80 & 11.73 \\ 
   \hline
\end{tabular}
\caption{compare graphs add edges by bn.cv (wave 4 \& Estonia)}
...
add VA \& DS \& HAM \&LWNP & 12.77 & 12.76 & 12.73 & 12.74 & 12.76 & 12.45 \\ 
   \hline
\end{tabular}
\caption{compare graphs add edges by bn.cv (multiple waves \& multiple countries)}
...
\caption{Markov blanket variables of AD\_1. Variables for DS are HAM, NOD and Sex (Top to bottom). Variable for Age is country.}
...
\caption{Markov blanket variables of AD\_2. Variables for EDUL are country, Age, and Sex (Top to bottom)}
