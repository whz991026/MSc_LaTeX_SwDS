...
\Large{Word Counts}
\end{center}
4973 words (including the executive summary, main text, references, and appendices). Excluding the acknowledgments, word counts, own work deceleration, contents, list of tables, and list of figures.
\clearpage
